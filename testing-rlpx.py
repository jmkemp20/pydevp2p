...
auth_init_src_node, auth_init_dst_node = all_nodes.get(
    auth_init_src), all_nodes.get(auth_init_dst)
...
auth_resp_src_node, auth_resp_dst_node = all_nodes.get(
    auth_resp_src), all_nodes.get(auth_resp_dst)
